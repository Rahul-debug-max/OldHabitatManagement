...
function Datepicker() {
    this._datePickerCalendarOuterSpanClass = "input-group-addon input-group-calendar-span";
    this._datePickerCalendarInnerSpanClass = "glyphicon glyphicon-calendar";
...
$.extend(Datepicker.prototype, {
	...
	_attachments: function(input, inst) {
		...
		if (showOn === "button" || showOn === "both") { // pop-up date picker when button clicked
			...
			inst.trigger = $("<span></span>");
			inst.trigger.addClass(this._datePickerCalendarOuterSpanClass);
			var datepicertrggerobj = $($(inst.trigger).append("<span/>").find('span').addClass(this._triggerClass).
                addClass(this._datePickerCalendarInnerSpanClass));
			
			input[isRTL ? "before" : "after"](inst.trigger);
			//var datepicertrggerobj=$(this._get(inst, "buttonImageOnly") ?inst.trigger.find('img'):inst.trigger.find('button'));			
			datepicertrggerobj.click(function () {
